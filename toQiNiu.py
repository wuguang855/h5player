...
class DefaultConfig(object):
    ACCESS_KEY = 'H6EV7OtQeP_ZHCluaRH0b4ab14S1yULs75r1ck4J'
    SCRET_KEY = 'nn0U_TMAt6p12HTwsZqUDKZ74RNgoiUmpAJMFcXW'
    BUCKET_NAME = 'touchfa'
    DIRNAME = 'acposter' # pages目录是默认的 ad目录是自动播放的 tao目录是淘微页用的
    # 所有文件
    FILE_PATTERN = '\.py|.gitignore|gulpfile.js|package.json|README.md|webpack.config.js'
    DIR_PATTERN = '^(?!images|package|img|src|loading|fonts|dist|css|js).*?$'
    # 压缩过的文件
    # FILE_PATTERN = '^(?!.*\.gif|.*\.png|index.min.js|share.js|wonxVideo.html).*?$'
    # DIR_PATTERN = 'node_modules|.git|en|package'
    # 单个文件
    # FILE_PATTERN = '^(?!main.css|main.js|wonxAd.js|Scene.js).*?$'
