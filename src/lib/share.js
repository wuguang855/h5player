//(function() {
  ...
  function _initWX(data) {
    ...
    _require([wxapi], function(wx) {
      ...
      wx.config({debug:false, appId:conf.appId, timestamp:conf.timestamp, nonceStr:conf.nonceStr, signature:conf.signature, jsApiList:["onMenuShareTimeline", "onMenuShareAppMessage", "onMenuShareQQ", "onMenuShareQZone", "getNetworkType","chooseWXPay"]});
      ...
      wx.ready(function() {
        wx.getNetworkType({
            ...
            success: function (res) {
               ...
               // document.getElementById("networkstatus").value=networkType;
            }
